...
echo "<label for='sl_distance_unit'>".__('Distance Unit', 'csl-slplus').':</label>';
echo "<select name='sl_distance_unit'>";
...
echo "<div class='section_column'>";
echo '<h2>'.__('Tags', 'csl-slplus').'</h2>';
echo '<div class="section_column_content">';
