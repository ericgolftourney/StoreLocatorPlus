    ...
    <tr>
        <td style='padding-top:0px;' valign='top'>
            <form name='manualAddForm' method=post enctype="multipart/form-data">
                ...
                <thead><tr><th><?php _e("Enter An Address", SLPLUS_PREFIX);?></th></tr></thead>
                <tr><td>
                    <div class="add_location_form">
                    <label  for='sl_store'><?php _e('Name of Location', SLPLUS_PREFIX);?></label>
                    <input name='sl_store'><br/>

                    <label  for='sl_address'><?php _e('Street - Line 1', SLPLUS_PREFIX);?></label>
                    <input name='sl_address'><br/>

                    <label  for='sl_address2'><?php _e('Street - Line 2', SLPLUS_PREFIX);?></label>
                    <input name='sl_address2'><br/>

                    <label  for='sl_city'><?php _e('City, State, ZIP', SLPLUS_PREFIX);?></label>
                    ...
                    <label  for='sl_country'><?php _e('Country', SLPLUS_PREFIX);?></label>
                    <input name='sl_country'><br/>
                    <br/>
                    <input type='submit' value='<?php _e("Add Location", SLPLUS_PREFIX);?>' class='button-primary'>
                    </div>
        </td></tr>
        <thead><tr><th><?php _e("Additional Information", SLPLUS_PREFIX);?></th></tr></thead>
        <tr><td><div class="add_location_form">
		    <label for='sl_description'><?php _e("Description", SLPLUS_PREFIX);?></label>
            <textarea name='sl_description' rows='5'></textarea><br/>

            <label for='sl_tags'><?php _e("Tags", SLPLUS_PREFIX);?></label>
            ...
            <label for='sl_email'><?php _e("email", SLPLUS_PREFIX);?></label>
            ...
            <label for='sl_image'><?php _e("Image URL (shown with location)", SLPLUS_PREFIX);?></label>
