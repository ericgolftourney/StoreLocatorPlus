...
* Mobile Listener Available

= 3.0.5 (June 11th 2012) =

* [security] Fixed an issue where the installation path could be viewed
* [security] Fixed an SQL injection vulnerability
...
* Added a please rate us feature
